    ...
    <DashboardLayout>
      <div className="flex flex-col items-center justify-center min-h-[85vh] bg-gradient-to-br from-purple-600 via-indigo-700 to-blue-800 text-white p-6 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="bg-white/10 backdrop-blur-lg p-6 rounded-2xl shadow-xl w-full max-w-md flex flex-col gap-4 relative z-10"
        >
          {/* Currency Selection */}
          <select
            value={currency}
          ...
          <p className="text-sm opacity-80">
            Send exactly the amount of <strong>{currency}</strong> you entered
